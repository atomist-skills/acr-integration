...
exports.doClone = exports.ClonePath = void 0;
const os = require("os");
...
exports.ClonePath = path.join(os.tmpdir(), "atm-clone");
async function doClone(id, options = {}) {
    ...
    const repoDir = options.path || path.join(exports.ClonePath, util_1.guid());
    ...
    try {
        await child_process_1.execPromise("git", ["checkout", checkoutRef, "--"], {
            cwd: repoDir,
        });
    }
    catch (err) {
