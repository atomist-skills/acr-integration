...
exports.captureLog = exports.ConsoleLog = exports.execPromise = exports.ExecPromiseError = exports.spawnPromise = exports.killProcess = exports.childProcessString = void 0;
...
async function spawnPromise(cmd, args = [], opts = {}) {
    ...
    return new Promise(resolve => {
        ...
        function pLog(data) {
            const formatted = optsToUse.log && optsToUse.log.stripAnsi
        ...
        if (optsToUse.timeout) {
            timer = setTimeout(() => {
                commandLog(`Child process timeout expired, killing command: ${cmdString}`, log_1.debug);
...
function captureLog(cb = log_1.debug) {
    const logLines = [];
    return {
        write: (msg) => {
            let line = msg;
