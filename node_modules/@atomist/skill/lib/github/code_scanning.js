...
exports.uploadCodeScanningResults = void 0;
 ...
 */
async function uploadCodeScanningResults(ctx, id, results) {
    let sarif;
    ...
    try {
        await operation_1.api(id).codeScanning.uploadSarif({
            owner: id.owner,
            repo: id.repo,
            commit_sha: id.sha,
        ...
        console_1.debug(`Uploading code scanning results failed: ${e.message}`);
    }
}
exports.uploadCodeScanningResults = uploadCodeScanningResults;
//# sourceMappingURL=code_scanning.js.map